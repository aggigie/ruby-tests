...
RSpec.describe Grep do
  ...
  it 'one file one match without flags' do
    pattern = 'Agamemnon'
    flags = []
    files = ['iliad.txt']
  ...
  it 'one file several matches without flags' do
    pattern = 'may'
    flags = []
  ...
  it 'multiple files one match without flags' do
    pattern = 'Agamemnon'
    flags = []
  ...
  it 'multiple files several matches without flags' do
    pattern = 'may'
    flags = []
    files = ['iliad.txt', 'midsummer-night.txt', 'paradise-lost.txt']
